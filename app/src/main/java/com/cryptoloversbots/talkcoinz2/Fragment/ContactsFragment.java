package com.cryptoloversbots.talkcoinz2.Fragment;
...
import com.cryptoloversbots.talkcoinz2.Models.ModelsUsersContacts;
                ...
                userRef.child(usersId).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild("image")) {
                            String upp = Objects.requireNonNull(dataSnapshot.child("image").getValue()).toString();
                            String uname = Objects.requireNonNull(dataSnapshot.child("aname").getValue()).toString();
